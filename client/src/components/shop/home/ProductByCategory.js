...
const AllProduct = ({ products }) => {
  ...
  return (
    <Fragment>
      ...
      <section className="m-4 md:mx-8 md:my-4 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6" >
        {products && products.length > 0 ? (
          products.map((item, index) => {
            return (
              <Fragment key={index}>
                <div className="relative col-span-1 m-2" style={{
                  ...
                  <img
                    ...
                    className="w-full object-cover object-center cursor-pointer customize-size-img"
