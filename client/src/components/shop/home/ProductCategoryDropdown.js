...
const CategoryList = () => {
  ...
  return (
    <div className={`${data.categoryListDropdown ? "" : "hidden"} my-4`}>
      <hr />
      <div className="py-1 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6" >
            ...
            return (
              <Fragment key={index}>
                <div
                  ...
                  className="col-span-1 m-2 flex flex-col items-center justify-center space-y-2 cursor-pointer" style={{
                    boxShadow: '0 1px 2px -1px rgba(16,24,40,.1), 0 1px 3px rgba(16,24,40,.1)',
                    borderRadius: '10px',
                    padding: '16px',
                    height: '100%',
                    backgroundColor: '#fff' }}
                >
                  <img className="categoryfilter"
  ...
  return (
    ...
    >
      <input 
        ...
        className="custom-input px-4 text-xl py-4 focus:outline-none" 
        type="text"
