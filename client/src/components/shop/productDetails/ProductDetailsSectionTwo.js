...
const Menu = () => {
  ...
  return (
    <Fragment>
      <div className=" review flex flex-col md:flex-row items-center justify-center">
        <div
  ...
  return (
    <Fragment>
      <section className="m-4 md:mx-12 md:my-8">
        <Menu />
        {data.menu ? (
          <div className=" review-text mt-6">{singleProduct.pDescription}</div>
        ) : (
          <RatingReview />
        )}
      </section>
      <div className="review-category m-4 md:mx-8 md:my-6 ml:200px flex justify-center capitalize font-light tracking-widest  text-gray-800 px-4 py-4 space-x-4">
        <div>
          <span>Category :</span>
